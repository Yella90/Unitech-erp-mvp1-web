              ...
              {summary.subscriptionStatus.status === 'active' ? (
                <div className="rounded-xl bg-white/70 px-3 py-2">
                  <p className="text-xs uppercase tracking-wide text-slate-500">
                    {summary.subscriptionStatus.remainingUnit === 'days' ? 'Jours restants' : 'Mois restants'}
                  </p>
                  <p className="font-semibold text-slate-900">
                    {summary.subscriptionStatus.remainingValue !== null
                      ? summary.subscriptionStatus.remainingUnit === 'days'
                        ? `${summary.subscriptionStatus.remainingValue} jour(s)`
                        : `${summary.subscriptionStatus.remainingValue} mois`
